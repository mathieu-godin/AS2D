...
namespace AtelierXNA
{
    ...
    public class VaisseauSpatial : SpriteAnimé
    {
        ...
        public override void Initialize()
        {
            ...
            Position = new Vector2(Position.X - RectangleImageÀAfficher.Width / DIVISEUR_OBTENTION_DEMI_GRANDEUR, Position.Y - RectangleImageÀAfficher.Height / DIVISEUR_OBTENTION_DEMI_GRANDEUR); // Nouvelle ligne
            AnciennePosition = new Vector2(Position.X, Position.Y);
            OrdonnéeFinaleVaisseau = Game.Window.ClientBounds.Height - RectangleImageÀAfficher.Height; 
            EnDescente = true;
        ...
        void GérerDescenteDuVaisseau()
        {
            ...
            RectangleImageÀAfficher = CalculerRectangleImageÀAfficher();
        ...
        void LancerMissile()
        {
            ...
            if (nbreDeMissiles < NB_DE_MISSILES_MAX)
            {
                Missile missile = new Missile(Game, "Missile",
                                                new Vector2(RectangleImageÀAfficher.X + RectangleImageÀAfficher.Width / 2 - 4, RectangleImageÀAfficher.Y - RectangleImageÀAfficher.Height / 4),

...
namespace AtelierXNA
{
    ...
    public class VaisseauSpatial : SpriteAnimé
    {
        ...
        {
            RectangleSource = new Rectangle((RectangleSource.X + (int)DimensionsImageÀLAffichage.X) % Image.Width,
                             (int)DimensionsImageÀLAffichage.Y *AnimationSelonLeDéplacement,
                             (int)DimensionsImageÀLAffichage.X, (int)DimensionsImageÀLAffichage.Y);
        }
